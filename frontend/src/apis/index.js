...
const SALE_DETAIL='/api/sale/sheetContent/time';
// 销售退货管理
...
//收款管理
const COLLECTION_ALL = '/api/collection/sheet-show';
const COLLECTION_CREATE = '/api/collection/sheet-make';
const COLLECTION_SECOND_APPROVAL = '/api/collection/second-approval';
