...
public class SaleServiceImpl implements SaleService {
    ...
    public void makeSaleSheet(UserVO userVO, SaleSheetVO saleSheetVO) {
        ...
        totalAmount=totalAmount.subtract(voucheramount);
        saleSheetPO.setFinalAmount(totalAmount);
    ...
    @Override
    public List<SaleScheduleDetailPO> getSaleScheduleDetail(String beginDateStr, String endDateStr, String productName, Integer supplier, String salesman) {
        try{
            SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date beginDate = format.parse(beginDateStr);
            Date endDate = format.parse(endDateStr);
            if(beginDate.after(endDate))return null;
            return saleSheetDao.getSaleScheduleDetail(beginDate,endDate,productName,supplier,salesman);
