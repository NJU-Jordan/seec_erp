...
public class CustomerServiceImpl implements CustomerService {
    ...
    public void createCustomer(CustomerPO customerPO){customerDao.createCustomer(customerPO);}
    public void deleteCustomerById(Integer id){customerDao.deleteCustomerById(id);}
}
