...
public interface SaleService {
    ...
    /**
     * 销售查看：设定一个时间段，查看此时间段内的出/入库数量/金额/商品信息/分类信息
     * @return
     * @throws ParseException
     */
    List<SaleScheduleDetailPO> getSaleScheduleDetail(String beginDateStr,String endDateStr, String productName, Integer supplier, String salesman);
