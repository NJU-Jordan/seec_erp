...
import com.nju.edu.erp.utils.PoiUtils;
...
//    }
    ...
    public void exportExcel(HttpServletResponse response) throws IOException {
        java.lang.System.out.println(warehouseService.findAll());
        PoiUtils.exportJobLevelExcel(warehouseService.findAll(),response);
    }
