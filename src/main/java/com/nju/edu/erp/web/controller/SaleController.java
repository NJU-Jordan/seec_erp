...
import com.nju.edu.erp.model.po.SaleScheduleDetailPO;
...
public class SaleController {
    ...
    public Response getSaleScheduleDetail(@RequestParam String beginDateStr,@RequestParam String endDateStr,@RequestParam String productName,@RequestParam Integer supplier, @RequestParam String salesman) throws ParseException {
        List<SaleScheduleDetailPO> ans=saleService.getSaleScheduleDetail(beginDateStr,endDateStr,productName,supplier,salesman);
        return Response.buildSuccess(ans);
    }
}
